    ...
    <div class="row mt-5 justify-content-center">
        <div class="col-6 justify-content-center">
            <div class="card mt-3 shadow-lg p-3 mb-2 bg-white rounded">
                <form method="post" action="<?php echo e(route('periksa/data')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group row">
                    <label for="tanggal_lahir" class="col-4 col-form-label">Tanggal Lahir/Usia</label> 
                    <div class="col-8">
                    <input id="tanggal_lahir" name="tanggal_lahir" placeholder="Hari, Tanggal Bulan Tahun" type="date" class="form-control" required="required">
                    </div>
                </div>
                <div class="form-group row">
...
</html><?php /**PATH C:\laravel\ti13\resources\views/periksa/index.blade.php ENDPATH**/ ?>