						...
						<div class="wrap-table-shopping-cart">
							<table class="table-shopping-cart">
								...
								<tr class="table_row">
									...
									<td class="column-2">bp/Apparel/Shut Down Cropped Hoodie Front.png</td>
									...
									<td class="column-5">Rp 650.000</td>
								</tr>
								...
								<tr class="table_row">
									...
									<td class="column-2">Shut Down Necklace</td>
									<td class="column-3">Rp 379.000</td>
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											<div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
												<i class="fs-16 zmdi zmdi-minus"></i>
									...
									<td class="column-5">Rp 379.000</td>
								</tr>
								<tr class="table_row">
									<td class="column-1">
										<div class="how-itemcart1">
									...
									<td class="column-2">The Album (Version 3)</td>
									<td class="column-3">Rp 445.000</td>
									<td class="column-4">
										<div class="wrap-num-product flex-w m-l-auto m-r-0">
											<div class="btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m">
												<i class="fs-16 zmdi zmdi-minus"></i>
											...
											<input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product2" value="2">
									...
									<td class="column-5">Rp 890.000</td>
								</tr>
